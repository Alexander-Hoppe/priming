...
checkPolarity.addEventListener("click", async () => {
	...
	chrome.scripting.executeScript({
	    	...
	    	(injectionResults) => {
				...
				document.getElementById("output").innerHTML = frameResult.result; //Printing the contents of the current tab into the popup, hand this over to website content next
    		});
